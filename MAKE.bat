...
if "!tier!" == "debug" (
    rem See: /GS /GS- and /Gs[N]
    rem https://learn.microsoft.com/en-us/cpp/build/reference/gs-control-stack-checking-calls?view=msvc-170
...
if "!tier!" == "release" (
    set args=!args! /DNDEBUG=2 /Os /Ox /O2 /Oy /GL /GF
    set libs=!libs! /OPT:ICF,3
)
if "!tier!" == "retail" (
    set args=!args! /DNDEBUG=3 /Os /Ox /O2 /Oy /GL /GF /Gw /arch:AVX2
