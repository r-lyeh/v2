...
CIMGUI_API void ImGuizmo_ViewManipulate_Float(float* view,float length,ImVec2 position,ImVec2 size,ImU32 backgroundColor,float *extra) //< @r-lyeh += extra
{
    return ImGuizmo::ViewManipulate(view,length,position,size,backgroundColor,extra); //< @r-lyeh += extra
}
CIMGUI_API void ImGuizmo_ViewManipulate_FloatPtr(float* view,const float* projection,IMGUIZMO_OPERATION operation,IMGUIZMO_MODE mode,float* matrix,float length,ImVec2 position,ImVec2 size,ImU32 backgroundColor,float *extra) //< @r-lyeh += extra
{
    return ImGuizmo::ViewManipulate(view,projection,operation,mode,matrix,length,position,size,backgroundColor,extra); //< @r-lyeh += extra
}
