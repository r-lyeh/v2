...
#include <stdint.h>
        ...
        #define API_C //< @r-lyeh += _C
    #else
        #define API_C __declspec(dllexport) //< @r-lyeh += _C
    #endif
#else
    #ifdef __GNUC__
        #define API_C  __attribute__((__visibility__("default"))) //< @r-lyeh += _C
    #else
        #define API_C //< @r-lyeh += _C
    #endif
#endif
...
CIMGUI_API ImGuiIO* igGetIO(void); //< @r-lyeh
