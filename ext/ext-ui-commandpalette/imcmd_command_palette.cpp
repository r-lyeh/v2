...
#else //< @r-lyeh
                    draw_list->AddText(font_regular, font_regular->FontSize * font_scale, text_pos, text_color_regular, begin, end);
#endif
...
#else //< @r-lyeh
            draw_list->AddText(font_regular, font_regular->FontSize * font_scale, text_pos, text_color_regular, text + range_end); // Draw until \0
#endif
...
#else //< @r-lyeh
            draw_list->AddText(font_regular, font_regular->FontSize * font_scale, text_pos, text_color_regular, text);
#endif
        }
