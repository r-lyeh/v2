...
#define EDITOR_FUNCTION(CMD,KEYS) \
    void macro(editor_bind_##CMD##_fn_)(); AUTORUN { array_push(editor_bindings, ((editor_binding_t){#CMD,editor_key(#CMD,KEYS),macro(editor_bind_##CMD##_fn_)}) ); } void macro(editor_bind_##CMD##_fn_)()
