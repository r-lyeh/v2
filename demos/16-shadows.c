...
int MODEL = 0;
const char *MODELS[] = {
#if __has_include("demos/meshes/ShadowsTest.obj")
    "meshes/ShadowsTest.obj",
#endif
#if __has_include("demos/meshes/suzanne.obj")
    "meshes/suzanne.obj",
#endif
#if __has_include("demos/meshes/sphere.obj")
    "meshes/sphere.obj",
#endif
#if __has_include("demos/meshes/gazebo.obj")
    "meshes/gazebo.obj",
#endif
#if __has_include("lab/art/models/machina/Type93_02.obj")
    "models/machina/Type93_02.obj",
#endif
#if __has_include("lab/art/models/street/Highway_Interchange.obj")
    "models/street/Highway_Interchange.obj",
#endif
};
...
int main(int argc, char** argv) {
    ...
    while( app_swap()) {
        ...
        if (mode == DIR) {
            ...
            if (rotate_sun) {
                lights[0].dir.x = cosf(window_time());
                lights[0].dir.z = sinf(window_time());
            }
        }
        ...
        if( ui_panel("Scene", UI_OPEN)) {
            ...
            static const array(char*) list; do_once for( int i = 0; i < countof(SKYBOXES); ++i ) array_push(list, SKYBOXES[i][0]);
