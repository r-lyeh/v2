...
- Engine and Editor assets can be optionally embedded into output binary now.
- Engine can interop with C/C++ external code now.
- And more.
...
- [x] Single batch file, Unlicensed, Small, Naive, Simple C.
